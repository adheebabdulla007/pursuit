...
function validateSalaryInput(value: string, label: string): string {
...
function CreateJobPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const minError = validateSalaryInput(salaryMin, 'Salary Min')
    const maxError = validateSalaryInput(salaryMax, 'Salary Max')
    setSalaryMinError(minError)
    setSalaryMaxError(maxError)
